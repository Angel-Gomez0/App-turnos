...
<html lang="es">
                                    ...
                                    <div class="panel-body">
                                        <form id = "appointmentForm" role="form" name="book" method="post" action="../../controllers/insertAppointment.php">
                                            <div class="form-group">
                                                ...
                                                <input id = "id_specialist" name="id_specialist" type="text" class="form-control" readonly value="<?php echo $doctorId; ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="DoctorSpecialization">Especialización Médico</label>
                                                <input id = "id_speciality" name="id_speciality" type="text" class="form-control" readonly value="Clinico">
                                            </div>                                            

                                            <div class="form-group">
                                                <label for="consultancyfees">Obra social</label>
                                                <select id = "healthInsaurance" name="healthInsaurance" class="form-control">
    ...
    function updateAvailability() {
        ...
        // Resetear los valores del input de tiempo y mensaje por si no se encuentra un horario disponible
        timeInput.min = '';
        timeInput.max = '';
        timeInput.step = '';
